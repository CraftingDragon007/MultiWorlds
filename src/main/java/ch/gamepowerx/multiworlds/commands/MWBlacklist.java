            ...
            switch (args[0]) {
                ...
                case "remove":
                    if (Bukkit.getPlayer(args[1]) != null) {
                        ...
                        if (world.getBlacklist().remove(Objects.requireNonNull(target1).getUniqueId())) {
                            player.sendMessage("§aDer Spieler §6" + target1.getName() + "§a wurde von der Blacklist der Welt §6" + world.getWorld().getName() + "§a entfernt!");
                        } else
                            player.sendMessage("§cDer Spieler §6" + target1.getName() + "§c war nicht auf der Blacklist der Welt §6" + world.getWorld().getName() + "§c!");
                        ...
                        if (world.getBlacklist().remove(uuid)) {
                            ...
                            player.sendMessage("§cDer Spieler §6" + args[1] + "§c war nicht auf der Blacklist der Welt §6" + world.getWorld().getName() + "§c!");
                ...
                case "remove":
                    if (Bukkit.getPlayer(args[1]) != null) {
                        ...
                        if (world.getBlacklist().remove(Objects.requireNonNull(target1).getUniqueId())) {
                            ...
                            sender.sendMessage("§cDer Spieler §6" + target1.getName() + "§c war nicht auf der Blacklist der Welt §6" + world.getWorld().getName() + "§c!");
                        ...
                        if (world.getBlacklist().remove(uuid)) {
                            ...
                            sender.sendMessage("§cDer Spieler §6" + args[2] + "§c war nicht auf der Blacklist der Welt §6" + world.getWorld().getName() + "§c!");
